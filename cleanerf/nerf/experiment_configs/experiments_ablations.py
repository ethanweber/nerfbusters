...
dataset_lists = [
    Argument(
        name="garbage",
        arg_string="--data data/cleanerf-dataset/garbage --pipeline.nerf_checkpoint_path outputs-pretrained/aloe/aloe-baseline.ckpt --output-dir outputs-postprocessed/garbage",
    )
]
